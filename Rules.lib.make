...
SOURCES += $(TVPSND_BASE)/tvpsnd.c $(TVPSND_BASE)/common.rc
OBJECTS := $(SOURCES:.c=.o)
...
clean:
	rm -f $(OBJECTS) $(OBJECTS_BIN) $(BINARY) $(BINARY_STRIPPED) $(ARCHIVE) $(TVPSND_BASE)/common_ppdefs.rc

$(TVPSND_BASE)/common.rc: $(TVPSND_BASE)/common_ppdefs.rc

$(TVPSND_BASE)/common_ppdefs.rc:
